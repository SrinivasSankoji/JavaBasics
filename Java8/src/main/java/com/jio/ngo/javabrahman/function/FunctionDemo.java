...
public class FunctionDemo {
	...
	public static void main(String[] args) 
	{
		 ...
		 * Accepts Employee and
		 * Returns String
		 */
		Function<Employee, String> functionString=(Employee e) -> {return e.getName();};
	...
	private static List<Employee> convertIdentity(List<Employee> employeeList, Function<Employee, Employee> functionString) 
	{
	...
	private static List<String> convertNamesToString(List<Employee> employeeList, Function<Employee, String> functionString) 
	{

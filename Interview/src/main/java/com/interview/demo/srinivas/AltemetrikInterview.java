...
public class AltemetrikInterview {
	...
	public static void main(String[] args) {
		...
		//Arrays.stream(text).collect(Collectors.toMap(Function.identity(), s ->s.length()));
		...
		List<Integer> totalSeries=IntStream.range(numbers[0], numbers[numbers.length-1]).boxed().collect(Collectors.toList());
